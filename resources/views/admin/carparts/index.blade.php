<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="GET" action="{{ route('admin.carparts.index') }}">
                <!-- Your filter form content -->
            </form>

            <!-- Add a car part button -->
            <x-primary-button>
                <a href="{{ route('admin.carparts.create') }}">Add a car part</a>
            </x-primary-button>
                ...
                <div class="my-2 p-6 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
                    ...
                    <p>
                        ...
                        @if ($carpart->car_part_image)
                            <a href="{{ route('admin.carparts.show', $carpart) }}">
